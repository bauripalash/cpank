/* vim: set encoding=utf-8 fileencoding=utf-8 tabstop=4 shiftwidth=4 expandtab
 */
...
static wchar_t BN_KW_RETURN[] = [] = "ফেরাও";
static wchar_t BN_KW_AND[] = [] = "এবং";
static wchar_t BN_KW_OR[] = [] = "বা";
static wchar_t BN_KW_IF[] = [] = "যদি";
static wchar_t BN_KW_THEN[] = [] = "তাহলে";
static wchar_t BN_KW_ELSE[] = [] = "নাহলে";
static wchar_t BN_KW_END[] = [] = "শেষ";
static wchar_t BN_KW_WHILE[] = [] = "যতক্ষণ";
static wchar_t BN_KW_TRUE[] = [] = "সত্যি";
static wchar_t BN_KW_FALSE[] = [] = "মিথ্যা";
static wchar_t BN_KW_NIL[] = [] = "শূন্য";
static wchar_t BN_KW_FUNC[] = [] = "কাজ";
*/
